...
const itemsToAdd = [
  ...
  },
  {
    ...
    weights: [
      2.700, 2.770, 2.770, 3.140 // Pg 2 (2 Pcs) + Pg 4 (2 Pcs)
    ]
  }
]

async function insert5MettiVarieties() {
  console.log("=== INSERTING 46 PCS (5 METTI VARIETIES) INTO SUPABASE ===")
  ...
  // Check updated final live stock total
